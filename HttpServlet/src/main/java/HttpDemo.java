...
public class HttpDemo extends HttpServlet{
	...
	public void doGet(HttpServletRequest request ,HttpServletResponse response) throws ServletException ,IOException{
		 ...
		 pw.println("<!DOCTYPE html>");
	        pw.println("<html>");
	        pw.println("<head>");
	        pw.println("<title>Jump & Hover Animation</title>");
	        pw.println("<style>");
	        ...
	        pw.println("  transition: transform 0.3s, color 0.3s;");
	        ...
	        // Hover & Jump Effect
	        pw.println(".word:hover {");
	        pw.println("  animation: jump 0.5s ease;");
	        pw.println("  color: yellow;");
	        pw.println("}");
	        pw.println("@keyframes jump {");
	        pw.println("  0% {transform: translateY(0);}");
	        pw.println("  50% {transform: translateY(-20px);}");
	        pw.println("  100% {transform: translateY(0);}");
	        pw.println("}");
